...
<div class="hello">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <form class="form-inline" v-on:submit.prevent="getDetails">
                    <input type="text" v-model="username" class="form-control mb-2 mr-sm-2" placeholder="Username"
                            autofocus>
    ...
    <span aria-hidden="true">&times;</span>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <img v-bind:src="userAvatar" class="rounded-circle" />
                </div>
            ...
            if (this.username !== "") {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        let chrData = [];
                        let chrLabel = [];
                        this.userAvatar = response.data[0].actor.avatar_url;
                        ...
                        if (allCommits.length === 0) {
                            this.errorMessage =
                                "This user has not made any commits recently.";
                        }
                        this.renderChart();
                    })
                    .catch(error => {
